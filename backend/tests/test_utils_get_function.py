...
class TestUtilsGetFunction(unittest.TestCase):
    """
    ...
    PUBLIC_URL="https://quiplash-oew1g21-2324.azurewebsites.net/utils/get"
    TEST_URL = PUBLIC_URL
    ...
    def test_input3(self):
        ...
        # Get the prompt
        response = requests.get(url = self.TEST_URL, params={"code": "{}".format(self.Key)}, json=self.input3)
        print(response.json())
    ...
    def test_input4(self):
        ...
        # Get the prompt
        response = requests.get(url = self.TEST_URL, params={"code": "{}".format(self.Key)}, json=self.input4)
        print(response.json())
    ...
    def test_input5(self):
        ...
        # Get the prompt
        response = requests.get(url = self.TEST_URL, params={"code": "{}".format(self.Key)}, json=self.input5)
        print(response.json())
